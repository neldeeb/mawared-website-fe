...
export const flexabilityContent: flexabilityContentProps[] = [
  {
    ...
    gapSpace: "lg:w-[175px] xl:w-[280px] 2xl:w-[135px]",
  },
  {
    firstTitle: "GPS",
    ...
    iconUrl: "./img/flex-check-iocn.svg",
    gapSpace: "lg:w-[273px] xl:w-[368px] 2xl:w-[229px]",
  },
  {
    ...
    iconUrl: "./img/flex-check-iocn.svg",
    gapSpace: "lg:w-[350px] xl:w-[444px] 2xl:w-[311px]",
  },
  {
    firstTitle: "Payroll",
    ...
    iconUrl: "./img/flex-check-iocn.svg",
    gapSpace: "lg:w-[415px] xl:w-[530px] 2xl:w-[380px]",
  },
  {
